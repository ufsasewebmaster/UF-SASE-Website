...
--> statement-breakpoint
INSERT INTO `__new_personal_info`("user_id", "first_name", "last_name", "phone", "area_code") SELECT "user_id", "first_name", "last_name", "phone", "area_code" FROM `personal_info`;--> statement-breakpoint
