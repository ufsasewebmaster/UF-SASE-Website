      ...
      <div className="mt-12 flex min-h-screen flex-col items-center bg-white">
        <div className="flex w-full max-w-7xl flex-col items-start px-4 py-8 lg:flex-row">
          <header className="mr-8 mt-10 flex items-center px-5">
            ...
            <h2 className="font-oswald text-5xl font-semibold leading-tight text-gray-800 sm:text-7xl">
              SASE
              <br />
              ENGINEERING
              <br />
        ...
        <div className="w-full max-w-7xl px-4 py-8">
          ...
          <header className="mb-6 flex max-w-7xl items-center px-5">
            ...
            <h2 className="font-oswald text-4xl text-gray-800">Past Projects</h2>
          </header>
          <Carousel purpose="Testimonials" prog="SET" />
          <header className="mb-12 flex max-w-7xl items-center px-5">
            <div className="mr-3 h-11 w-1.5 bg-saseGreen"></div>
            <h2 className="font-oswald text-4xl text-gray-800">Goals & Outcomes</h2>
          </header>
          ...
          <header className="flex max-w-7xl items-center px-5">
            <div className="mr-3 h-11 w-1.5 bg-saseGreen"></div>
            <h2 className="font-oswald text-4xl text-gray-800">FAQs</h2>
          </header>
          <FAQ faqData={faqData} />
        </div>
      </div>
