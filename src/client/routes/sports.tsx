            ...
            <InfoCard
              text={
                <>
                  ...
                  <strong>6v6 Indoor Volleyball, Indoor Soccer, Ultimate Frisbee, Doubles Pickleball </strong> and more, available in Fall, Spring,
                  and Summer semesters! SASE Sports provides a fantastic opportunity to meet new people, and the best part is, no prior experience is
                  required to play. Make sure to sign up for an amazing experience!
                </>
              }
            />
          </div>
