...
const ProgramCard: React.FC<ProgramCardProps> = ({ image, link, text }) => {
  return (
    <div className="relative mb-24 w-full max-w-6xl p-6">
      ...
      <div className="relative flex transform flex-col items-center rounded-3xl border-2 border-black bg-gray-100 p-12 shadow-[16px_16px_0px_#7DC242] transition duration-300 hover:shadow-[24px_24px_0px_#7DC242] sm:flex-row">
        {/* Image */}
