...
import type { InsertTodo, UpdateTodo } from "@/shared/todoSchema";
  ...
  component: () => {
    ...
    return (
      <div className="mx-auto max-w-md rounded-lg bg-background p-4 shadow-md">
        <div>
          <h1 className="text-2xl font-bold">Testing users get and set:</h1>
          <p className="text-muted-foreground">
            A fullstack web framework for Deno
          </p>
        </div>
