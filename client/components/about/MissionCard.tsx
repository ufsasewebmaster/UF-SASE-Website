...
const MissionCard = ({ logo, shadowColor, text, title }: CardProps) => {
  return (
    <div className="flex-none">
      <div
        className={cn(
          `flex h-72 w-56 transform flex-col items-center justify-between rounded-2xl border-2 border-black bg-gray-100 p-4 transition duration-300 hover:scale-105`,
          {
